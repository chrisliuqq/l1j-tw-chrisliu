 ...
 *
 */
// XXX: ChrisLiu.20101013: 先採用 V1 的方法，有機會再來研究 V2 的方法。
public class V1Map extends L1Map{
	private int _mapId;
	private int _startX;
	private int _startY;
	private int _endX;
	 ...
	 * V1Map 的建構子
	 * @param mapId 地圖編號
	 * @param map 地圖 raw data
	 * @param startX X軸的起始座標
	 * @param startY Y軸的起始座標
	 * @param attribute 地圖的屬性
	 */
	public V1Map(int mapId, byte map[][], int startX, int startY, int attribute) {
		_mapId = mapId;
		_map = map;
		_startX = startX;
		_startY = startY;
		...
		_isEnabledDeathPenalty = (attribute & ENABLED_DEATH_PENALTY) == 1 ? true : false;
	...
	/**
	 * @param _mapId the _mapId to set
	 */
	...
	/**
	 * @param _startX the _startX to set
	 */
	...
	/**
	 * @param _startY the _startY to set
	 */
	...
	/**
	 * @param _isUnderwater the _isUnderwater to set
	 */
	...
	/**
	 * @param _isMarkable the _isMarkable to set
	 */
	...
	/**
	 * @param _isTeleportable the _isTeleportable to set
	 */
	...
	/**
	 * @param _isEscapable the _isEscapable to set
	 */
	...
	/**
	 * @param _isUseResurrection the _isUseResurrection to set
	 */
	...
	/**
	 * @param _isUsePainwand the _isUsePainwand to set
	 */
	...
	/**
	 * @param _isEnabledDeathPenalty the _isEnabledDeathPenalty to set
	 */
	...
	/**
	 * @param _isTakePet the _isTakePet to set
	 */
	...
	/**
	 * @param _isRecallPet the _isRecallPet to set
	 */
	...
	/**
	 * @param _isUsableItem the _isUsableItem to set
	 */
	...
	/**
	 * @param _isUsableSkill the _isUsableSkill to set
	 */
